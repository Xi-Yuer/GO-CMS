    ...
    return (
        <>
            <Layout className='h-screen overflow-hidden select-none'>
                <Sider width='250px' theme={themeMode} className='hidden md:block' trigger={null} collapsible
                       collapsed={isFold}>
                    <div
                ...
                <Layout>
                    <Header
                        className='flex items-center justify-between bg-white dark:bg-[#001624] dark:text-white px-6'>
                        {isFold ? (
                        ...
                        <div
                            ...
                            <Suspense fallback={
                                <Spin spinning={true}
                                      ...
                                      indicator={<Image src={LoadingGIF} style={{
                                          width: '100px',
                                          height: '100px'
                                      }}/>}>
                                </Spin>}>
